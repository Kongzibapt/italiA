...
export function buildMarcoSystemPrompt(
  ...
  return [
    ...
    '',
    'Style : 3-4 phrases max. ✅ si juste, ❌ + correction d\'une phrase + petit encouragement si faux. Pas de listes ni de titres. Parle toujours à la première personne — jamais de formules indirectes comme "Marco te demande". Ne traduis jamais l\'italien entre parenthèses.',
    '',
