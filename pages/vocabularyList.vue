    ...
    <div class="space-y-4">
      ...
      <div v-else class="flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-4">
          <button
            class="sticky z-[5] flex items-center gap-2 w-full text-left bg-background py-2 -mx-10 px-10 lg:-mx-20 lg:px-20 before:absolute before:inset-x-0 before:bottom-full before:h-8 before:bg-background"
